...
* Extended support up to 48 months (When paired with link:https://access.redhat.com/support/policy/updates/openshift#eust3[OpenShift/MicroShift EUS Term 3^]).
...
[source,sh,role=execute]
----
sudo podman images | grep microshift-bootc-embeeded
----
